...
- [常见问答（FAQ）](#常见问答faq)
- [国外常用网站导航（独立页）]({{ site.repo_url }}/blob/main/sites.md)

---

## 本站导航（站内入口）

- 新手从 0 到 1：[Clash 机场零基础图文教程]({{ site.repo_url }}/blob/main/clash.md)
- 机场选购与避坑：[如何挑选优质 Clash 机场（避坑与选购指南）]({{ site.repo_url }}/blob/main/choose.md)
- 线路科普（直连/中转/专线）：[直连/中转/专线（IEPL/IPLC）区别与选择]({{ site.repo_url }}/blob/main/route.md)
- 协议科普（Reality/TUIC/Hysteria2 等）：[协议科普与选型]({{ site.repo_url }}/blob/main/protocols.md)
- 名词解释：[Clash 机场常用名称解释]({{ site.repo_url }}/blob/main/mingci.md)
...
- **搜索引擎**：Google、DuckDuckGo、Startpage、Yahoo（Bing 在部分网络环境可用性存在波动）
...
- **AI 工具**：ChatGPT、Gemini、Copilot、Claude、Perplexity AI
...
3. 按图文教程完成配置：导入订阅 → 选 `Rule` 模式 → 开启系统代理或 `TUN` → 测速选节点 → 访问测试网站。
   - 图文教程（含各平台客户端）：[2026 Clash 机场零基础订阅图文教程：订阅导入到测速]({{ site.repo_url }}/blob/main/clash.md)
4. 选购前先把关键概念搞懂（能少踩一半坑）：
   - 选购与避坑优先看：[2026 如何挑选优质 Clash 机场（避坑与选购指南）]({{ site.repo_url }}/blob/main/choose.md)
...
- **完全新手（只想尽快稳定可用）**：先按图文做一遍导入与连通性验证 → 再学会怎么挑机场与线路  
  [Clash 机场零基础图文教程]({{ site.repo_url }}/blob/main/clash.md) → [挑选机场（避坑）]({{ site.repo_url }}/blob/main/choose.md) → [线路科普（直连/中转/专线）]({{ site.repo_url }}/blob/main/route.md)
- **AI 工具（ChatGPT/Claude）重度**：优先搞定“地区可用性 + 稳定性”，别频繁换节点  
  [挑选机场（偏 AI/原生 IP）]({{ site.repo_url }}/blob/main/choose.md) → [协议科普（Reality/TUIC/Hysteria2 等）]({{ site.repo_url }}/blob/main/protocols.md)
- **流媒体/跨区（Netflix/Disney+/Max）**：关键在“解锁维护 + 线路质量”，优先看线路与排障  
  [线路科普]({{ site.repo_url }}/blob/main/route.md) → [排障要点](#troubleshoot) → [机场避坑]({{ site.repo_url }}/blob/main/choose.md)
...
> 详细下载入口与图文操作：见 [Clash 机场零基础图文教程]({{ site.repo_url }}/blob/main/clash.md)。
...
> 想搞懂细节：看 [线路科普]({{ site.repo_url }}/blob/main/route.md) 与 [协议科普]({{ site.repo_url }}/blob/main/protocols.md)。
...
- [2026 Clash 机场零基础订阅图文教程：订阅导入到测速]({{ site.repo_url }}/blob/main/clash.md)
- [2026 如何挑选优质 Clash 机场（避坑与选购指南）]({{ site.repo_url }}/blob/main/choose.md)
- [线路科普：直连/中转/专线（IEPL/IPLC）区别与选择]({{ site.repo_url }}/blob/main/route.md)
- [协议科普：VMess/VLESS/Trojan/Reality/TUIC/Hysteria 等怎么选]({{ site.repo_url }}/blob/main/protocols.md)
- [名词科普大全：Clash 机场常用名称解释]({{ site.repo_url }}/blob/main/mingci.md)
...
- 线路（直连/中转/专线）：[直连、中转、专线 Clash 机场线路原理与选择指南]({{ site.repo_url }}/blob/main/route.md)
- 协议：[协议科普：VMess/VLESS/Trojan/Reality/TUIC/Hysteria 等怎么选]({{ site.repo_url }}/blob/main/protocols.md)

---

## 🌐 国外常用网站导航

为避免首页过长、并降低后续维护成本，本清单已独立整理为：[`sites.md`]({{ site.repo_url }}/blob/main/sites.md)
